...
outdir = "outdir_relative_binning_reduced"
label = "eob_time_domain_source_model_relative_binning_reduced"

# call the waveform_generator to create our waveform model.
waveform = bilby.gw.waveform_generator.WaveformGenerator(
    duration=duration,
    sampling_frequency=sampling_frequency,
    frequency_domain_source_model = eob.eob_waveform_model_fd,
...
prior["chi_1"] = -.4
prior["chi_2"] = -.2
prior["lambda_tilde"] = bilby.core.prior.Uniform( 300, 500, "lambda_tilde")
prior["delta_lambda_tilde"] = bilby.core.prior.Uniform(-300, 300, "delta_lambda_tilde")
prior["lambda_1"] = bilby.core.prior.Constraint(name="lambda_1", minimum=0, maximum=10000)
prior["lambda_2"] = bilby.core.prior.Constraint(name="lambda_2", minimum=0, maximum=10000)
prior["r_M_init"] = 24
prior["phi_init"] = 0.0
...
alt_waveform_generator = bilby.gw.WaveformGenerator(
    ...
    frequency_domain_source_model=eob.eob_waveform_model_fd_no_fid,
    parameter_conversion = lambda x : (x , []),
    start_time=injection_parameters["geocent_time"] - 0.5,
)
